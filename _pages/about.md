...
selected_visualizations: true # includes a list of visualizations marked as "selected={true}"
...
During my PhD, I created the toolkit <strong>Crystal Orbital Guided Iteration To atomic-Orbitals (COGITO)</strong>. 
